$(document).ready(function () {
  ...
  $('.js-basket-carousel').slick({
    arrows: true,
    dots: false,
    infinite: false,
    slidesToShow: 3,
    slidesToScroll: 1,
    prevArrow: '<button class="basket-carousel__prev"><svg xmlns="http://www.w3.org/2000/svg" width="11px" height="17px" viewBox="0 0 11 17"><path fill-rule="evenodd" stroke="rgb(191, 158, 124)" stroke-width="2px" stroke-linecap="butt" stroke-linejoin="miter" fill="none" d="M7.401,14.187 L1.297,7.985 C1.217,7.899 1.177,7.792 1.177,7.684 C1.177,7.576 1.217,7.468 1.297,7.383 L7.401,1.181 " /></svg></button>',
    nextArrow: '<button class="basket-carousel__next"><svg xmlns="http://www.w3.org/2000/svg" width="11px" height="17px" viewBox="0 0 11 17"><path fill-rule="evenodd" stroke="rgb(217, 184, 152)" stroke-width="2px" stroke-linecap="butt" stroke-linejoin="miter" fill="none" d="M2.599,1.813 L8.703,8.015 C8.783,8.100 8.823,8.208 8.823,8.316 C8.823,8.424 8.783,8.532 8.703,8.617 L2.599,14.819 " /></svg></button>',
    responsive: [
      {
        breakpoint: 767.98,
        settings: {
  ...
  if (window.matchMedia("(min-width: 768px)").matches) {
    ...
    $('.js-categories-dropdown').click(function (e) {
      ...
      if (button.hasClass('categories__dropdown--expanded')) {
        ...
        $('.js-categories-dropdown').removeClass('categories__dropdown--expanded');
        $('.js-categories-dropdown').parent().removeClass('header__categories--expanded');
        $('.js-categories-dropdown').parent().find('.categories__links').not('.categories__links--sublevel').slideUp();
